          ...
          <View style={styles.sectionBottom}>
            <View style={{ alignItems: 'flex-start'}}>
              <Button
                ...
                icon={<Icon name={'chevron-left'} style={{alignSelf:'center'}}  size={responsiveWidth(10)} color="#fff" />}
            ...
            <View style={{ alignItems: 'flex-end'}}>
              <Button
                ...
                icon={<Icon name={'chevron-right'} style={{alignSelf:'center'}} size={responsiveWidth(10)} color="#fff" />}
